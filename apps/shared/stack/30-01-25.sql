...
CREATE TABLE IF NOT EXISTS public.ocr_usu_2fa
(
    id serial NOT NULL,
    token integer NOT NULL,
    id_usuario integer NOT NULL,
    tipo_recuperacion smallint DEFAULT 1,
    estado boolean DEFAULT true,
    fecha_init information_schema.time_stamp NOT NULL,
    fecha_fin timestamp without time zone,
    estado_confirmacion integer DEFAULT 1,
    CONSTRAINT ocr_usu_token_pk PRIMARY KEY (id)
);

COMMENT ON COLUMN public.ocr_usu_2fa.estado_confirmacion
    IS '1 por confirma, 2 confirmado, 3 anulado';
...
ALTER TABLE IF EXISTS public.ocr_usu_2fa
    ADD CONSTRAINT ocr_usu_2fa_ocr_usu_usuario_fk FOREIGN KEY (id_usuario)
